          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: OrionDesignSystem.learningGradient,
  ...
  void _submitFinalAnswer() async {
    ...
    if (mounted) {
      ...
      if (_isFirstCompletion) {
        message = '🎉 Great job! +$xpToGive 💎 gems earned!';
      } else {
        // For repeats, don't mention XP at all
        message = '✅ Practice complete! Keep learning!';
      }
      
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(message),
          backgroundColor: _isFirstCompletion ? const Color(0xFF58CC02) : Colors.blue[600]!,
