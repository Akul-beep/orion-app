...
class TradingViewIframeWidget extends StatefulWidget {
  final String symbol;
  final double height;
  ...
  @override
  State<TradingViewIframeWidget> createState() => _TradingViewIframeWidgetState();
}

class _TradingViewIframeWidgetState extends State<TradingViewIframeWidget> {
  ...
  Widget _buildTradingViewIframe() {
    // Create the TradingView iframe URL
    final iframeUrl = _getTradingViewIframeUrl();
