...
class TradingViewHtmlEmbedded extends StatefulWidget {
  final String symbol;
  final double height;
  ...
  @override
  State<TradingViewHtmlEmbedded> createState() => _TradingViewHtmlEmbeddedState();
}

class _TradingViewHtmlEmbeddedState extends State<TradingViewHtmlEmbedded> {
