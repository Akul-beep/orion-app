...
class TradingViewEmbeddedWidget extends StatefulWidget {
  final String symbol;
  final double height;
  ...
  const TradingViewEmbeddedWidget({
    super.key,
  ...
  @override
  State<TradingViewEmbeddedWidget> createState() => _TradingViewEmbeddedWidgetState();
}

class _TradingViewEmbeddedWidgetState extends State<TradingViewEmbeddedWidget> {
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: Container(
                    child: TradingViewEmbeddedWidget(
