...
class TradingViewRealEmbedded extends StatefulWidget {
  final String symbol;
  final double height;
  ...
  @override
  State<TradingViewRealEmbedded> createState() => _TradingViewRealEmbeddedState();
}

class _TradingViewRealEmbeddedState extends State<TradingViewRealEmbedded> {
